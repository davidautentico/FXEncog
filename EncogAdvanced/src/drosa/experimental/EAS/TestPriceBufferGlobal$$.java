...
public class TestPriceBufferGlobal$$ {
	...
	public static double doTest(
		...
		for (int i=100;i<data.size()-1;i++){
			...
			/*int actualTrades = wins+losses;
			if (actualTrades>=tradesCheckPoint){
				int actualPips = winPips-lostPips;
				
				
				tradesCheckPoint += 200;
			}*/
		}//data
	...
	public static void main(String[] args) throws Exception {
		...
		String pathEURUSD = "C:\\fxdata\\EURUSD_5 Mins_Bid_2004.01.01_2019.07.23.csv";
